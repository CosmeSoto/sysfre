...
class ItemCarrito(ModeloBase):
    ...
    def save(self, *args, **kwargs):
        ...
        # Calcular impuesto unitario
        if self.es_servicio:
            # Los servicios tienen IVA fijo del 12%
            self.impuesto_unitario = (self.precio_unitario * 12) / 100
        else:
            self.impuesto_unitario = (self.precio_unitario * self.producto.iva) / 100
