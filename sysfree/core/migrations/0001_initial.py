    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('texto', 'Texto'), ('numero', 'Número'), ('booleano', 'Booleano'), ('json', 'JSON'), ('fecha', 'Fecha')], default='texto', max_length=20, verbose_name='tipo')),
                ('descripcion', models.TextField(blank=True, verbose_name='descripción')),
                ('es_sistema', models.BooleanField(default=False, help_text='Indica si es una configuración interna del sistema', verbose_name='es configuración de sistema')),
